...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) {
        ...
        if (!userRepository.existsByGithubId(githubId)) {
            User user = new User(githubId, email, name, image, bio);
        ...
        // reuse existing authorities, updating the attribvutes with email, and setting the email with the principal name attribute
