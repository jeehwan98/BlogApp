(function (f) {
    ...
    return (function () {
        ...
        1: [function (require, module, exports) {
            ...
            module.exports = {
                default: Format.RFC3986, formatters: {
                    RFC1738: function (e) {
        ...
        2: [function (require, module, exports) {
            "use strict";
            var stringify = require(4), parse = require(3), formats = require(1);
            module.exports = {formats: formats, parse: parse, stringify: stringify};

        }, {"1": 1, "3": 3, "4": 4}],
        3: [function (require, module, exports) {
            "use strict";
            var utils = require(5), has = Object.prototype.hasOwnProperty, isArray = Array.isArray, defaults = {
                allowDots: !1,
                allowEmptyArrays: !1,
                allowPrototypes: !1,
                allowSparse: !1,
            ...
            }, isoSentinel = "utf8=%26%2310003%3B", charsetSentinel = "utf8=%E2%9C%93", parseValues = function parseQueryStringValues(e, t) {
                var r = {__proto__: null}, a = t.ignoreQueryPrefix ? e.replace(/^\?/, "") : e;
                a = a.replace(/%5B/gi, "[").replace(/%5D/gi, "]");
                var i, o = t.parameterLimit === 1 / 0 ? void 0 : t.parameterLimit, l = a.split(t.delimiter, o), s = -1, n = t.charset;
                ...
                for (i = 0; i < l.length; ++i) if (i !== s) {
                    var p, c, d = l[i], u = d.indexOf("]="), f = -1 === u ? d.indexOf("=") : u + 1;
                ...
                for (var i = a ? t : parseArrayValue(t, r), o = e.length - 1; o >= 0; --o) {
                    ...
                    if ("[]" === s && r.parseArrays) l = r.allowEmptyArrays && ("" === i || r.strictNullHandling && null === i) ? [] : [].concat(i); else {
                        ...
                        var n = "[" === s.charAt(0) && "]" === s.charAt(s.length - 1) ? s.slice(1, -1) : s, p = r.decodeDotInKeys ? n.replace(/%2E/g, ".") : n,
                            c = parseInt(p, 10);
                        r.parseArrays || "" !== p ? !isNaN(c) && s !== p && String(c) === p && c >= 0 && r.parseArrays && c <= r.arrayLimit ? (l = [])[c] = i : "__proto__" !== p && (l[p] = i) : l = {0: i}
                    }
                    i = l
                }
                return i
                ...
                if (e) {
                    var i = r.allowDots ? e.replace(/\.([^.[]+)/g, "[$1]") : e, o = /(\[[^[\]]*])/g, l = r.depth > 0 && /(\[[^[\]]*])/.exec(i),
                        s = l ? i.slice(0, l.index) : i, n = [];
                    if (s) {
                ...
                var t = void 0 === e.charset ? defaults.charset : e.charset, r = void 0 === e.duplicates ? defaults.duplicates : e.duplicates;
            ...
            module.exports = function (e, t) {
                ...
                for (var a = "string" == typeof e ? parseValues(e, r) : e, i = r.plainObjects ? Object.create(null) : {}, o = Object.keys(a), l = 0; l < o.length; ++l) {
                    var s = o[l], n = parseKeys(s, a[s], r, "string" == typeof e);
                    i = utils.merge(i, n, r)
                }
        ...
        4: [function (require, module, exports) {
            "use strict";
            var getSideChannel = require(29), utils = require(5), formats = require(1), has = Object.prototype.hasOwnProperty, arrayPrefixGenerators = {
                brackets: function brackets(e) {
                    return e + "[]"
                }, comma: "comma", indices: function indices(e, r) {
                    return e + "[" + r + "]"
                }, repeat: function repeat(e) {
                    return e
                }
            }, isArray = Array.isArray, push = Array.prototype.push, pushToArray = function (e, r) {
            ...
            }, sentinel = {}, stringify = function stringify(e, r, t, o, a, n, i, l, s, f, u, d, y, c, p, m, h, v) {
                ...
                if ("comma" === t && isArray(w)) m && s && (w = utils.maybeMap(w, s)), E = [{value: w.length > 0 ? w.join(",") || null : void 0}]; else if (isArray(f)) E = f; else {
                    var S = Object.keys(w);
                    E = u ? S.sort(u) : S
                }
                var O = l ? r.replace(/\./g, "%2E") : r, T = o && isArray(w) && 1 === w.length ? O + "[]" : O;
                if (a && isArray(w) && 0 === w.length) return T + "[]";
                for (var k = 0; k < E.length; ++k) {
                    var I = E[k], P = "object" == typeof I && void 0 !== I.value ? I.value : w[I];
                    if (!i || null !== P) {
                        var x = d && l ? I.replace(/\./g, "%2E") : I, z = isArray(w) ? "function" == typeof t ? t(T, x) : T : T + (d ? "." + x : "[" + x + "]");
                        v.set(e, g);
                ...
                var o, a = formats.formatters[t], n = defaults.filter;
            ...
            module.exports = function (e, r) {
                var t, o = e, a = normalizeStringifyOptions(r);
                "function" == typeof a.filter ? o = (0, a.filter)("", o) : isArray(a.filter) && (t = a.filter);
                var n = [];
                if ("object" != typeof o || null === o) return "";
                var i = arrayPrefixGenerators[a.arrayFormat], l = "comma" === i && a.commaRoundTrip;
                ...
                var d = n.join(a.delimiter), y = !0 === a.addQueryPrefix ? "?" : "";
        ...
        5: [function (require, module, exports) {
            "use strict";
            var formats = require(1), has = Object.prototype.hasOwnProperty, isArray = Array.isArray, hexTable = function () {
            ...
            }, limit = 1024, encode = function encode(e, r, t, o, n) {
                ...
                for (var r = [{
                    ...
                    var u = c[i], p = a[u];
                    "object" == typeof p && null !== p && -1 === t.indexOf(p) && (r.push({obj: a, prop: u}), t.push(p))
                }
            ...
            module.exports = {/* common-shake removed: arrayToObject:arrayToObject *//* common-shake removed: assign:assign */
                combine: combine,
                compact: compact,
                decode: decode,
                encode: encode,
        ...
        29: [function (require, module, exports) {
            "use strict";
            var GetIntrinsic = require(20), callBound = require(7), inspect = require(27), $TypeError = require(16), $WeakMap = GetIntrinsic("%WeakMap%", !0),
                $Map = GetIntrinsic("%Map%", !0), $weakMapGet = callBound("WeakMap.prototype.get", !0), $weakMapSet = callBound("WeakMap.prototype.set", !0),
                $weakMapHas = callBound("WeakMap.prototype.has", !0), $mapGet = callBound("Map.prototype.get", !0),
                $mapSet = callBound("Map.prototype.set", !0), $mapHas = callBound("Map.prototype.has", !0), listGetNode = function (e, t) {
        ...
        7: [function (require, module, exports) {
            "use strict";
            var GetIntrinsic = require(20), callBind = require(8), $indexOf = callBind(GetIntrinsic("String.prototype.indexOf"));
        ...
        20: [function (require, module, exports) {
            "use strict";
            var undefined, $Error = require(12), $EvalError = require(11), $RangeError = require(13), $ReferenceError = require(14), $SyntaxError = require(15),
                $TypeError = require(16), $URIError = require(17), $Function = Function, getEvalledConstructor = function (r) {
                    try {
            ...
            }() : throwTypeError, hasSymbols = require(24)(), hasProto = require(23)(), getProto = Object.getPrototypeOf || (hasProto ? function (r) {
                return r.__proto__
            ...
            var doEval = function doEval(r) {
                ...
                }, bind = require(19), hasOwn = require(26), $concat = bind.call(Function.call, Array.prototype.concat),
                $spliceApply = bind.call(Function.apply, Array.prototype.splice), $replace = bind.call(Function.call, String.prototype.replace),
                $strSlice = bind.call(Function.call, String.prototype.slice), $exec = bind.call(Function.call, RegExp.prototype.exec),
                rePropName = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, reEscapeChar = /\\(\\)?/g,
            ...
            module.exports = function GetIntrinsic(r, e) {
                ...
                var t = stringToPath(r), o = t.length > 0 ? t[0] : "", n = getBaseIntrinsic("%" + o + "%", e), a = n.name, y = n.value, i = !1, p = n.alias;
                p && (o = p[0], $spliceApply(t, $concat([0, 1], p)));
                for (var d = 1, s = !0; d < t.length; d += 1) {
                    var f = t[d], u = $strSlice(f, 0, 1), l = $strSlice(f, -1);
        ...
        8: [function (require, module, exports) {
            "use strict";
            var bind = require(19), GetIntrinsic = require(20), setFunctionLength = require(28), $TypeError = require(16),
                $apply = GetIntrinsic("%Function.prototype.apply%"), $call = GetIntrinsic("%Function.prototype.call%"),
                $reflectApply = GetIntrinsic("%Reflect.apply%", !0) || bind.call($call, $apply), $defineProperty = require(10),
        ...
        10: [function (require, module, exports) {
            "use strict";
            var GetIntrinsic = require(20), $defineProperty = GetIntrinsic("%Object.defineProperty%", !0) || !1;
        ...
        28: [function (require, module, exports) {
            "use strict";
            var GetIntrinsic = require(20), define = require(9), hasDescriptors = require(22)(), gOPD = require(21), $TypeError = require(16),
        ...
        9: [function (require, module, exports) {
            "use strict";
            var $defineProperty = require(10), $SyntaxError = require(15), $TypeError = require(16), gopd = require(21);
            module.exports = function defineDataProperty(e, r, o) {
                ...
                var n = arguments.length > 3 ? arguments[3] : null, l = arguments.length > 4 ? arguments[4] : null,
                    t = arguments.length > 5 ? arguments[5] : null, i = arguments.length > 6 && arguments[6], a = !!gopd && gopd(e, r);
        ...
        21: [function (require, module, exports) {
            "use strict";
            var GetIntrinsic = require(20), $gOPD = GetIntrinsic("%Object.getOwnPropertyDescriptor%", !0);
            if ($gOPD) try {
                $gOPD([], "length")
            } catch (t) {
                $gOPD = null
        ...
        18: [function (require, module, exports) {
            "use strict";
            var ERROR_MESSAGE = "Function.prototype.bind called on incompatible ", toStr = Object.prototype.toString, max = Math.max,
                funcType = "[object Function]", concatty = function concatty(t, n) {
        ...
        26: [function (require, module, exports) {
            "use strict";
            var call = Function.prototype.call, $hasOwn = Object.prototype.hasOwnProperty, bind = require(19);
            module.exports = bind.call(call, $hasOwn);

        }, {"19": 19}],
        24: [function (require, module, exports) {
            "use strict";
            var origSymbol = "undefined" != typeof Symbol && Symbol, hasSymbolSham = require(25);
        ...
        22: [function (require, module, exports) {
            "use strict";
            var $defineProperty = require(10), hasPropertyDescriptors = function hasPropertyDescriptors() {
            ...
            (function (global) {
                (function () {
                    var hasMap = "function" == typeof Map && Map.prototype,
                        ...
                        mapForEach = hasMap && Map.prototype.forEach, hasSet = "function" == typeof Set && Set.prototype,
                        ...
                        setForEach = hasSet && Set.prototype.forEach, hasWeakMap = "function" == typeof WeakMap && WeakMap.prototype,
                        weakMapHas = hasWeakMap ? WeakMap.prototype.has : null, hasWeakSet = "function" == typeof WeakSet && WeakSet.prototype,
                        weakSetHas = hasWeakSet ? WeakSet.prototype.has : null, hasWeakRef = "function" == typeof WeakRef && WeakRef.prototype,
                        weakRefDeref = hasWeakRef ? WeakRef.prototype.deref : null, booleanValueOf = Boolean.prototype.valueOf,
                        objectToString = Object.prototype.toString, functionToString = Function.prototype.toString, $match = String.prototype.match,
                        $slice = String.prototype.slice, $replace = String.prototype.replace, $toUpperCase = String.prototype.toUpperCase,
                        $toLowerCase = String.prototype.toLowerCase, $test = RegExp.prototype.test, $concat = Array.prototype.concat,
                        $join = Array.prototype.join, $arrSlice = Array.prototype.slice, $floor = Math.floor,
                        bigIntValueOf = "function" == typeof BigInt ? BigInt.prototype.valueOf : null, gOPS = Object.getOwnPropertySymbols,
                    ...
                    function addNumericSeparator(t, e) {
                        ...
                        if ("number" == typeof t) {
                            ...
                            if (n !== t) {
                                var o = String(n), i = $slice.call(e, o.length + 1);
                    ...
                    var utilInspect = require(6), inspectCustom = utilInspect.custom, inspectSymbol = isSymbol(inspectCustom) ? inspectCustom : null;
                    ...
                    module.exports = function inspect_(t, e, r, n) {
                        ...
                        if ("function" == typeof t && !isRegExp(t)) {
                            var f = nameOf(t), s = arrObjKeys(t, inspect);
                        ...
                        if ("object" == typeof t && i) {
                            if (inspectSymbol && "function" == typeof t[inspectSymbol] && utilInspect) return utilInspect(t, {depth: p - r});
                        ...
                        if (!isDate(t) && !isRegExp(t)) {
                            var O = arrObjKeys(t, inspect), w = gPO ? gPO(t) === Object.prototype : t instanceof Object || t.constructor === Object,
                    ...
                    function arrObjKeys(t, e) {
                        ...
                        var i, a = "function" == typeof gOPS ? gOPS(t) : [];
